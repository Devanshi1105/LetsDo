...
namespace LetsCookApp.Views
{
    public partial class PopularReceipesView : ContentPage
    {
        public PopularReceipesView()
        {
            ...
            {
                new SubCategory {foodIcon = "Chutney.png" ,DishName = "Coconut Chutney", likeIcon = "icon.png" ,timeIcon = "icon.png" ,Time = "9 MIn", servingIcon = "icon.png", Servings="6 Servings",ingrendIcon="icon.png" , Ingrendients="14 Ingredients" ,plusIcon="icon.png"},
